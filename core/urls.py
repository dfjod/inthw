...
urlpatterns = [
    ...
    path('objects/', views.ObjectListCreate.as_view(), name = 'object-view-create'),
    ...
    path('objects/<int:pk>/', views.ObjectRetrieveUpdateDestory.as_view(), name = 'object-view-retrieve-udpate-destroy')
]